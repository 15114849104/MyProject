...
<title>登录界面</title>
<link rel="stylesheet" type="text/css" href="/naire/front/login/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/naire/front/login/css/style.css" />
<script src="/naire/front/login/js/jquery-1.7.2.min.js" type="text/javascript"></script>
...
<div class="login_div">
	...
	<form action="/naire/user/login.do" class="login" method="post">
		<div class="nav">
...
<div class="register_body">
	...
	<form action="/naire/user/register.do" class="register" method="post">
		<div class="nav">
			<div class="nav register_nav">
				...
				<div class="col-xs-6">
					<input type="text" name="account" id="name_r" value="" placeholder="&nbsp;&nbsp;用户名/手机号" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
